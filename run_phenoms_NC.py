...
def run_sienax(t1):
    sub = t1.split('/')[5] +'-'+ t1.split('/')[6]
    t1_out =  '/data/henry12/phenoms/Newcastle/sienax_output/' + sub
...
def run_first(t1):
    ...
    sub = t1.split('/')[5] +'_'+ t1.split('/')[6].replace(".nii.gz","")
    odir =  '/data/henry12/phenoms/Newcastle/first_output/' + sub
    print("output", odir)
...
subjects = glob('{}/F*/*MPRAGE*'.format(base_dir))
for s in subjects:
    #print(s)
