...
def write_csv(c,out):
    ...
    for idx in range(len(df)):
        ...
        proj = df.loc[idx, 'Project']
        sub = df.loc[idx, 'Subject']
        T1 = df.loc[idx, 'T1']

        first_path =  glob('/data/henry12/phenoms/OSLO/first_output/{}/{}/'.format(proj,sub))
        print(first_path)
        ...
        sienax_path =  glob('/data/henry12/phenoms/OSLO/sienax_output/{}/{}/'.format(proj,sub))
