...
base_dir = '//data/henry12/phenoms/Basel/MRI/'
...
def run_sienax(t1):
    sub = t1.split('/')[8] + "_" + t1.split('/')[9]
    t1_out =  '/data/henry12/phenoms/Basel/sienax_output/' + sub
    #print(t1_out)
...
def run_first(t1):
    sub =  t1.split('/')[8] + "_" + t1.split('/')[9]
    odir =  '/data/henry12/phenoms/Basel/first_output/' + sub
    print(odir)
...
subjects = glob('{}/*/*MPRAGE*'.format(base_dir))
"""for s in subjects:
    #print(s)
...
for s in os.listdir(base_dir):
    ...
    for f in os.listdir(file):
        ...
        for t1 in os.listdir(o):
            ...
            """os.chdir(o)
            print("cd", o)
            if t1.endswith(".tar.gz") and t1.startswith("t1n"):
                cmd = ["tar", "-xvzf", o +'/'+ t1]
                print("tar", "-xvzf", o + '/'+ t1)
                print(cmd)
                Popen(cmd).wait()"""
